                                ...
                                <select name="owner_id_new" id="owner_id_new" class="form-control">
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}"
                                            {{ $user->outlet_id !== null && $user->outlet_id !== $outlet->id ? 'disabled' : '' }}>
                                            {{-- Disable `user` pemiliki outlet ini --}}
                                            @if ($user->outlet === null)
                        ...
                        @else
                            <div class="form-group">
                                ...
                                <select name="owner_id" id="owner_id" class="form-control">
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}"
                                            {{ $user->outlet_id !== null ? 'disabled' : '' }}> {{-- Disable `user` yang sudah memiliki outlet --}}
