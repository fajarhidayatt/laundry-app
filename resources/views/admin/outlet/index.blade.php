        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="white-box">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ route('admin.outlet.create') }}" class="btn btn-primary box-title">
                            ...
                            <tbody>
                                @forelse ($outlets as $outlet)
                                    <tr>
                                        ...
                                        <td>{{ $outlet->name }}</td>
                                        <td>
                                            {{ $outlet->owner != null && $outlet->owner?->role === 'owner' ? $outlet->owner->name : 'Belum ada owner' }}
                                        </td>
                                        ...
                                        <td align="center">
                                            <div style="display: flex;">
                                                <a
                                                    href="{{ route('admin.outlet.edit', $outlet->id) }}"
                                                    data-toggle="tooltip"
