                ...
                <div class="white-box">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <br>
                            <strong>Uang Bayar Rp.
                                {{ number_format($transaction->detailTransaction->total_payment, 0, ',', '.') }}
                            </strong>
                            <br>
                            <strong>Kembalian Rp.
                                {{ number_format($transaction->detailTransaction->total_payment - $transaction->detailTransaction->total_price, 0, ',', '.') }}
                            </strong>
                            <br>
                            <br>
                            <a href="{{ route('cashier.transaction.index') }}" class="btn btn-primary">
