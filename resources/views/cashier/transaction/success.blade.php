                ...
                <div class="white-box">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <strong>Total Pembayaran Rp.
                                {{ number_format($transaction->detailTransaction->total_price, 0, ',', '.') }}</strong><br><br>
                            <a href="{{ route('cashier.transaction.index') }}" class="btn btn-primary">Kembali Ke Menu
                                Utama</a>
                        </div>
                    </div>
