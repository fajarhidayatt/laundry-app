                ...
                <div class="white-box">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <small style="display: block; margin-bottom: 20px;">Jika pelanggan belum terdaftar, maka
                                daftarkan dulu lewat <strong>menu pelanggan</strong></small>
                        </div>
                            ...
                            <tbody>
                                @forelse ($members as $member)
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a
                                                href="{{ route('cashier.transaction.create', $member->id) }}"
                                                data-toggle="tooltip"
