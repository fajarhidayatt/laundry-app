...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="white-box">
                    <form action="{{ route('cashier.packet.update', $packet->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="outlet_name" id="outlet_name" class="form-control" disabled
                                value="{{ $packet->outlet->name }}">
                            <input type="text" name="outlet_id" id="outlet_id" class="form-control" readonly
                                value={{ $packet->outlet_id }} style="display: none;">
                        </div>
