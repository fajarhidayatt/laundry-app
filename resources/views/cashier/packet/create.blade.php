            ...
            <div class="white-box">
                <form action="/cashier/packet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="outlet_name" id="outlet_name" class="form-control" disabled value="{{ $outlet->name }}">
                        <input type="text" name="outlet_id" id="outlet_id" class="form-control" readonly value={{ $outlet->id }} style="display: none;">
                    </div>
